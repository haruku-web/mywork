      ...
      <section class="about" id="about">
        ...
        <div class="about-container">
          ...
          <div class="about-item about-text">
            ...
            <p>
              使用言語は、HTML,CSS,PHP,MySQL,Javascript(React)です。 <br>
      ...
      <section class="works" id="works">
        ...
        <div class="works-wrapper">
          <div class="works-box wb1">
            <img class="work-image" src="images/bbs.png" alt="">
            <p class="work-text">
              ミニ掲示板<br>    
              <使用言語><br>
              PHP<br>
            ...
            <a href="bbs/bbs.php" class="button" target="_blank" rel="noopener">More</a>
          </div>
          <div class="works-box wb2">
            <img class="work-image" src="images/calc.png" alt="">
            <p class="work-text">
              簡易電卓<br>
              <使用言語><br>
              JavaScript<br>
            ...
            <a href="calc/calc.html" class="button" target="_blank" rel="noopener">More</a>
          </div>
          <div class="works-box wb3">
            <img class="work-image" src="images/todo.png" alt="">
            <p class="work-text">
              Todoリスト<br>
              <使用言語><br>
              JavaScript<br>
            ...
            <a href="Todo/todo.html" class="button" target="_blank" rel="noopener">More</a>
          </div>
        </div>
      </section>
